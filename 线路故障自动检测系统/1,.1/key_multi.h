...
#define MAIN_Fosc 24000000UL		//定义主频35MHz，请根据实际使用频率修改（用于delay函数自适应主频）

sbit KEY1 = P2^3;		//引脚定义：按键1 KEY1->P32		
sbit KEY2 = P2^4;		//引脚定义：按键2 KEY2->P33		
sbit KEY3 = P2^5;		//引脚定义：按键3 KEY3->P34		
sbit KEY4 = P2^6;		//引脚定义：按键4 KEY4->P35		
...
#define DOUBLE_KEY_TIME 30 								//判定单击时间：DOUBLE_KEY_TIME*10MS = 300MS
